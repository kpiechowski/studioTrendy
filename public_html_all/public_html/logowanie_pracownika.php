...
<head>
    ...
    <?php
        ...
        if (isset($_POST['login']) &&  isset($_POST['password'])){
            ...
            $user = $mysqli -> query("SELECT * FROM `pracownicy` WHERE `login`='$login' LIMIT 1");
            ...
            if(mysqli_num_rows($user) == 1){
                ...
                if(password_verify($password, $user_data['haslo'])){
...
<body>
    ...
    <main class="d-f jc-c ai-c">
        <div class="login_form d-f jc-c"> 
            ...
            <br>
            <div class="login_register"><b>Logowanie pracownika</b></div>
            <form action="logowanie_pracownika.php" method="POST">
